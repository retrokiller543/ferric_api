...
/// fn insert_one(model: &M) -> PgQuery<'_>; // Single item insertion query
/// fn update_one(model: &M) -> PgQuery<'_>; // Single item update query
/// fn delete_one_by_id(id: &M::Id) -> PgQuery<'_>; // Single item deletion query
/// ```
///
/// # Optional Methods
///
...
///
/// ```rust
/// async fn get_all(&self) -> ApiResult<Vec<M>>                  // Retrieve all records
/// async fn get_by_id(&self, id: impl Into<M::Id>) -> ApiResult<Option<M>> // Get by ID
/// ```
///
/// # Batch Operations
///
...
///     }
///
///     fn insert_one(user: &User) -> PgQuery<'_> {
...
/// async fn create_users(repo: &UserRepository, users: Vec<User>) -> ApiResult<()> {
...
/// # Error Handling
///
/// All operations return [`ApiResult<T>`], providing consistent error handling across
    ...
    M: Model,
{
    ...
    /// # Returns
    ///
    /// * [`PgQuery`] - A prepared PostgreSQL query ready for execution
    ///
    /// # Implementation Notes
    ///
    ...
    /// # Returns
    ///
    /// * [PgQuery] - A prepared PostgreSQL UPDATE query
    ///
    /// # Implementation Notes
    ///
    /// The query should:
    ...
    /// # Returns
    ///
    /// * [`PgQuery`] - A prepared PostgreSQL DELETE query
    ///
    /// # Implementation Notes
    ///
    /// Consider:
    ...
    /// # Returns
    ///
    /// * [`ApiResult<Vec<M>>`] - A Result containing a vector of all models if successful
    ///
    /// # Warning
    ///
    ...
    /// # Returns
    ///
    /// * [`ApiResult<Option<M>>`] - A Result containing either:
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if the insertion was executed, or an error if the operation failed
    ///
    /// # Example
    ///
    /// ```rust
    /// async fn create_user(repo: &UserRepository, user: &User) -> ApiResult<()> {
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if all insertions were executed, or an error if any operation failed
    ///
    /// # Example
    ///
    /// ```rust
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if all batches were processed, or an error if any operation failed
    ///
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if the update was executed, or an error if the operation failed
    ///
    /// # Implementation Details
    ///
    /// The method:
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if all updates were executed, or an error if any operation failed
    #[tracing::instrument(skip_all, level = "debug")]
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if the deletion was executed, or an error if the operation failed
    ///
    /// # Example
    ///
    /// ```rust
    /// async fn remove_user(repo: &UserRepository, user_id: i32) -> ApiResult<()> {
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if all deletions were executed, or an error if any operation failed
    #[tracing::instrument(skip_all, level = "debug")]
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if the operation was executed, or an error if it failed
    ///
    /// # Example
    ///
    /// ```rust
    /// async fn save_user(repo: &UserRepository, user: &User) -> ApiResult<()> {
    ...
    /// # Returns
    ///
    /// * [`ApiResult<()>`](ApiResult) - Success if all operations were executed, or an error if any failed
    #[tracing::instrument(skip_all, level = "debug")]
    #[inline]
    fn save_all(&self, models: impl IntoIterator<Item = M>) -> impl Future<Output = ApiResult<()>> {
